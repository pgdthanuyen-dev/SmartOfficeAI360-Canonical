...
3. `03-architecture/SYSTEM_ARCHITECTURE.md`, `CDP_ARCHITECTURE.md`, `NEOREMOTING_CONTRACT.md`, `DOWNLOAD_PIPELINE.md`, then `ARCHITECTURE.md`
4. `04-engineering/FORBIDDEN_ACTIONS.md`, `TEST_STRATEGY.md`, `SECURITY_RULES.md`, then `ENGINEERING_RULES.md`
5. `05-operations/RUNBOOK_CDP.md`, `TROUBLESHOOTING.md`, then `OPERATIONS.md`
